...
public abstract class Nodes {
    ...
    public static final class BackReferenceReadNode extends Node {
        ...
        public BackReferenceReadNode(int startOffset, int length, byte[] name) {
            super(startOffset, length);
            this.name = name;
        }
    ...
    public static final class BlockLocalVariableNode extends Node {
        ...
        public BlockLocalVariableNode(int startOffset, int length, short flags, byte[] name) {
            super(startOffset, length);
            this.flags = flags;
            this.name = name;
        }
    ...
    public static final class BlockNode extends Node {
        ...
        public BlockNode(int startOffset, int length, byte[][] locals, Node parameters, Node body) {
            super(startOffset, length);
            this.locals = locals;
    ...
    public static final class BlockParameterNode extends Node {
        ...
        public BlockParameterNode(int startOffset, int length, short flags, byte[] name) {
            super(startOffset, length);
            this.flags = flags;
            this.name = name;
        }
    ...
    public static final class CallAndWriteNode extends Node {
        ...
        public CallAndWriteNode(int startOffset, int length, short flags, Node receiver, byte[] read_name, byte[] write_name, Node value) {
            super(startOffset, length);
            this.flags = flags;
    ...
    public static final class CallNode extends Node {
        ...
        public CallNode(int startOffset, int length, short flags, Node receiver, byte[] name, ArgumentsNode arguments, Node block) {
            super(startOffset, length);
            this.flags = flags;
            this.receiver = receiver;
            this.name = name;
    ...
    public static final class CallOperatorWriteNode extends Node {
        ...
        public CallOperatorWriteNode(int startOffset, int length, short flags, Node receiver, byte[] read_name, byte[] write_name, byte[] binary_operator, Node value) {
            super(startOffset, length);
            this.flags = flags;
            this.receiver = receiver;
            this.read_name = read_name;
    ...
    public static final class CallOrWriteNode extends Node {
        ...
        public CallOrWriteNode(int startOffset, int length, short flags, Node receiver, byte[] read_name, byte[] write_name, Node value) {
            super(startOffset, length);
            this.flags = flags;
            this.receiver = receiver;
            this.read_name = read_name;
    ...
    public static final class CallTargetNode extends Node {
        ...
        public CallTargetNode(int startOffset, int length, short flags, Node receiver, byte[] name) {
            super(startOffset, length);
            this.flags = flags;
            this.receiver = receiver;
            this.name = name;
    ...
    public static final class ClassNode extends Node {
        ...
        public ClassNode(int startOffset, int length, byte[][] locals, Node constant_path, Node superclass, Node body, byte[] name) {
            super(startOffset, length);
            this.locals = locals;
    ...
    public static final class ClassVariableAndWriteNode extends Node {
        ...
        public ClassVariableAndWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class ClassVariableOperatorWriteNode extends Node {
        ...
        public ClassVariableOperatorWriteNode(int startOffset, int length, byte[] name, Node value, byte[] binary_operator) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
            this.binary_operator = binary_operator;
    ...
    public static final class ClassVariableOrWriteNode extends Node {
        ...
        public ClassVariableOrWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class ClassVariableReadNode extends Node {
        ...
        public ClassVariableReadNode(int startOffset, int length, byte[] name) {
            super(startOffset, length);
            this.name = name;
        }
    ...
    public static final class ClassVariableTargetNode extends Node {
        ...
        public ClassVariableTargetNode(int startOffset, int length, byte[] name) {
            super(startOffset, length);
            this.name = name;
        }
    ...
    public static final class ClassVariableWriteNode extends Node {
        ...
        public ClassVariableWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class ConstantAndWriteNode extends Node {
        ...
        public ConstantAndWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class ConstantOperatorWriteNode extends Node {
        ...
        public ConstantOperatorWriteNode(int startOffset, int length, byte[] name, Node value, byte[] binary_operator) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
            this.binary_operator = binary_operator;
    ...
    public static final class ConstantOrWriteNode extends Node {
        ...
        public ConstantOrWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class ConstantPathNode extends Node {
        ...
        public ConstantPathNode(int startOffset, int length, Node parent, byte[] name) {
            super(startOffset, length);
            this.parent = parent;
            this.name = name;
        }
    ...
    public static final class ConstantPathOperatorWriteNode extends Node {
        ...
        public ConstantPathOperatorWriteNode(int startOffset, int length, ConstantPathNode target, Node value, byte[] binary_operator) {
            super(startOffset, length);
            this.target = target;
            this.value = value;
            this.binary_operator = binary_operator;
    ...
    public static final class ConstantPathTargetNode extends Node {
        ...
        public ConstantPathTargetNode(int startOffset, int length, Node parent, byte[] name) {
            super(startOffset, length);
            this.parent = parent;
            this.name = name;
        }
    ...
    public static final class ConstantReadNode extends Node {
        ...
        public ConstantReadNode(int startOffset, int length, byte[] name) {
            super(startOffset, length);
            this.name = name;
        }
    ...
    public static final class ConstantTargetNode extends Node {
        ...
        public ConstantTargetNode(int startOffset, int length, byte[] name) {
            super(startOffset, length);
            this.name = name;
        }
    ...
    public static final class ConstantWriteNode extends Node {
        ...
        public ConstantWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class DefNode extends Node {
        ...
        public DefNode(int startOffset, int length, int serializedLength, Loader loader, byte[] name, Node receiver, ParametersNode parameters, Node body, byte[][] locals) {
            super(startOffset, length);
        ...
        public DefNode getNonLazy() {
            if (isLazy()) {
                return loader.createDefNodeFromSavedPosition(startOffset, length, -serializedLength);
            } else {
                return this;
            }
        }
    ...
    public static final class GlobalVariableAndWriteNode extends Node {
        ...
        public GlobalVariableAndWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class GlobalVariableOperatorWriteNode extends Node {
        ...
        public GlobalVariableOperatorWriteNode(int startOffset, int length, byte[] name, Node value, byte[] binary_operator) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
            this.binary_operator = binary_operator;
    ...
    public static final class GlobalVariableOrWriteNode extends Node {
        ...
        public GlobalVariableOrWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class GlobalVariableReadNode extends Node {
        ...
        public GlobalVariableReadNode(int startOffset, int length, byte[] name) {
            super(startOffset, length);
            this.name = name;
        }
    ...
    public static final class GlobalVariableTargetNode extends Node {
        ...
        public GlobalVariableTargetNode(int startOffset, int length, byte[] name) {
            super(startOffset, length);
            this.name = name;
        }
    ...
    public static final class GlobalVariableWriteNode extends Node {
        ...
        public GlobalVariableWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class IndexOperatorWriteNode extends Node {
        ...
        public IndexOperatorWriteNode(int startOffset, int length, short flags, Node receiver, ArgumentsNode arguments, BlockArgumentNode block, byte[] binary_operator, Node value) {
            super(startOffset, length);
            this.flags = flags;
            this.receiver = receiver;
            this.arguments = arguments;
    ...
    public static final class InstanceVariableAndWriteNode extends Node {
        ...
        public InstanceVariableAndWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class InstanceVariableOperatorWriteNode extends Node {
        ...
        public InstanceVariableOperatorWriteNode(int startOffset, int length, byte[] name, Node value, byte[] binary_operator) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
            this.binary_operator = binary_operator;
    ...
    public static final class InstanceVariableOrWriteNode extends Node {
        ...
        public InstanceVariableOrWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class InstanceVariableReadNode extends Node {
        ...
        public InstanceVariableReadNode(int startOffset, int length, byte[] name) {
            super(startOffset, length);
            this.name = name;
        }
    ...
    public static final class InstanceVariableTargetNode extends Node {
        ...
        public InstanceVariableTargetNode(int startOffset, int length, byte[] name) {
            super(startOffset, length);
            this.name = name;
        }
    ...
    public static final class InstanceVariableWriteNode extends Node {
        ...
        public InstanceVariableWriteNode(int startOffset, int length, byte[] name, Node value) {
            super(startOffset, length);
            this.name = name;
            this.value = value;
        }
    ...
    public static final class KeywordRestParameterNode extends Node {
        ...
        public KeywordRestParameterNode(int startOffset, int length, short flags, byte[] name) {
            super(startOffset, length);
            this.flags = flags;
            this.name = name;
        }
    ...
    public static final class LambdaNode extends Node {
        ...
        public LambdaNode(int startOffset, int length, byte[][] locals, Node parameters, Node body) {
            super(startOffset, length);
            this.locals = locals;
            this.parameters = parameters;
            this.body = body;
    ...
    public static final class LocalVariableAndWriteNode extends Node {
        ...
        public LocalVariableAndWriteNode(int startOffset, int length, Node value, byte[] name, int depth) {
            super(startOffset, length);
            this.value = value;
            this.name = name;
            this.depth = depth;
    ...
    public static final class LocalVariableOperatorWriteNode extends Node {
        ...
        public LocalVariableOperatorWriteNode(int startOffset, int length, Node value, byte[] name, byte[] binary_operator, int depth) {
            super(startOffset, length);
            this.value = value;
            this.name = name;
            this.binary_operator = binary_operator;
    ...
    public static final class LocalVariableOrWriteNode extends Node {
        ...
        public LocalVariableOrWriteNode(int startOffset, int length, Node value, byte[] name, int depth) {
            super(startOffset, length);
            this.value = value;
            this.name = name;
            this.depth = depth;
    ...
    public static final class LocalVariableReadNode extends Node {
        ...
        public LocalVariableReadNode(int startOffset, int length, byte[] name, int depth) {
            super(startOffset, length);
            this.name = name;
            this.depth = depth;
        }
    ...
    public static final class LocalVariableTargetNode extends Node {
        ...
        public LocalVariableTargetNode(int startOffset, int length, byte[] name, int depth) {
            super(startOffset, length);
            this.name = name;
            this.depth = depth;
        }
    ...
    public static final class LocalVariableWriteNode extends Node {
        ...
        public LocalVariableWriteNode(int startOffset, int length, byte[] name, int depth, Node value) {
            super(startOffset, length);
            this.name = name;
            this.depth = depth;
            this.value = value;
    ...
    public static final class ModuleNode extends Node {
        ...
        public ModuleNode(int startOffset, int length, byte[][] locals, Node constant_path, Node body, byte[] name) {
            super(startOffset, length);
            this.locals = locals;
            this.constant_path = constant_path;
            this.body = body;
     ...
     * </pre>
     */
    public static final class NoBlockParameterNode extends Node {

        public NoBlockParameterNode(int startOffset, int length) {
            super(startOffset, length);
        }
    ...
    public static final class OptionalKeywordParameterNode extends Node {
        ...
        public OptionalKeywordParameterNode(int startOffset, int length, short flags, byte[] name, Node value) {
            super(startOffset, length);
            this.flags = flags;
            this.name = name;
            this.value = value;
    ...
    public static final class OptionalParameterNode extends Node {
        ...
        public OptionalParameterNode(int startOffset, int length, short flags, byte[] name, Node value) {
            super(startOffset, length);
            this.flags = flags;
            this.name = name;
            this.value = value;
    ...
    public static final class ParametersNode extends Node {
        ...
        @Nullable
        @UnionType({ BlockParameterNode.class, NoBlockParameterNode.class })
        public final Node block;

        public ParametersNode(int startOffset, int length, Node[] requireds, OptionalParameterNode[] optionals, Node rest, Node[] posts, Node[] keywords, Node keyword_rest, Node block) {
            super(startOffset, length);
            this.requireds = requireds;
    ...
    public static final class ProgramNode extends Node {
        ...
        public ProgramNode(int startOffset, int length, byte[][] locals, StatementsNode statements) {
            super(startOffset, length);
            this.locals = locals;
            this.statements = statements;
        }
    ...
    public static final class RequiredKeywordParameterNode extends Node {
        ...
        public RequiredKeywordParameterNode(int startOffset, int length, short flags, byte[] name) {
            super(startOffset, length);
            this.flags = flags;
            this.name = name;
        }
    ...
    public static final class RequiredParameterNode extends Node {
        ...
        public RequiredParameterNode(int startOffset, int length, short flags, byte[] name) {
            super(startOffset, length);
            this.flags = flags;
            this.name = name;
        }
    ...
    public static final class RestParameterNode extends Node {
        ...
        public RestParameterNode(int startOffset, int length, short flags, byte[] name) {
            super(startOffset, length);
            this.flags = flags;
            this.name = name;
        }
    ...
    public static final class SingletonClassNode extends Node {
        ...
        public SingletonClassNode(int startOffset, int length, byte[][] locals, Node expression, Node body) {
            super(startOffset, length);
            this.locals = locals;
            this.expression = expression;
            this.body = body;
