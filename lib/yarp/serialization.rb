  ...
  module Serialization
    class << self
      ...
      def load_node(source, io)
        ...
        when 18 then YARP::Program.new(load_node(source, io), location)
        ...
        when 26 then YARP::UnlessNode.new(load_token(source, io), load_node(source, io), load_node(source, io), location)
        when 27 then YARP::UntilNode.new(load_token(source, io), load_node(source, io), load_node(source, io), location)
        when 28 then YARP::WhileNode.new(load_token(source, io), load_node(source, io), load_node(source, io), location)
        end
      end
    end
  end
