...
module YARP
  ...
  class AsPatternNode < Node
    ...
    # def accept: (visitor: Visitor) -> void
    def accept(visitor)
      visitor.visit_as_pattern_node(self)
    end
  ...
  class BlockParametersNode < Node
    ...
    # def initialize: (parameters: Node?, locals: Array[Token], location: Location) -> void
    def initialize(parameters, locals, location)
      @parameters = parameters
      @locals = locals
      @location = location
    end
    ...
    # def deconstruct_keys: (keys: Array[Symbol]) -> Hash[Symbol, nil | Node | Array[Node] | String | Token | Array[Token] | Location]
    def deconstruct_keys(keys)
      { parameters: parameters, locals: locals, location: location }
    end
  end
  ...
  class HeredocNode < Node
    ...
    # def initialize: (opening: Token, parts: Array[Node], closing: Token, dedent: Integer, location: Location) -> void
    def initialize(opening, parts, closing, dedent, location)
      @opening = opening
      @parts = parts
      @closing = closing
      @dedent = dedent
    ...
    # def accept: (visitor: Visitor) -> void
    def accept(visitor)
      visitor.visit_heredoc_node(self)
    end
    ...
    # def deconstruct_keys: (keys: Array[Symbol]) -> Hash[Symbol, nil | Node | Array[Node] | String | Token | Array[Token] | Location]
    def deconstruct_keys(keys)
      { opening: opening, parts: parts, closing: closing, dedent: dedent, location: location }
    end
  end
  ...
  class LambdaNode < Node
    ...
    # def initialize: (scope: Node, opening: Token, lparen: Token?, parameters: Node?, rparen: Token?, statements: Node?, location: Location) -> void
    def initialize(scope, opening, lparen, parameters, rparen, statements, location)
      @scope = scope
      @opening = opening
      @lparen = lparen
      @parameters = parameters
    ...
    # def deconstruct_keys: (keys: Array[Symbol]) -> Hash[Symbol, nil | Node | Array[Node] | String | Token | Array[Token] | Location]
    def deconstruct_keys(keys)
      { scope: scope, opening: opening, lparen: lparen, parameters: parameters, rparen: rparen, statements: statements, location: location }
    end
  end
  ...
  class ParametersNode < Node
    ...
    # def initialize: (requireds: Array[Node], optionals: Array[Node], rest: Node?, keywords: Array[Node], keyword_rest: Node?, block: Node?, location: Location) -> void
    def initialize(requireds, optionals, rest, keywords, keyword_rest, block, location)
      @requireds = requireds
      @optionals = optionals
      @rest = rest
      @keywords = keywords
    ...
    # def child_nodes: () -> Array[nil | Node]
    def child_nodes
      [*requireds, *optionals, rest, *keywords, keyword_rest, block]
    end
    ...
    # def deconstruct_keys: (keys: Array[Symbol]) -> Hash[Symbol, nil | Node | Array[Node] | String | Token | Array[Token] | Location]
    def deconstruct_keys(keys)
      { requireds: requireds, optionals: optionals, rest: rest, keywords: keywords, keyword_rest: keyword_rest, block: block, location: location }
    end
  end
  ...
  class Visitor < BasicVisitor
    ...
    # Visit a AsPatternNode node
    alias visit_as_pattern_node visit_child_nodes
    ...
    # Visit a HeredocNode node
    alias visit_heredoc_node visit_child_nodes
  ...
  module DSL
    ...
    # Create a new AsPatternNode node
    def AsPatternNode(value, target, operator_loc)
      AsPatternNode.new(value, target, operator_loc, Location.null)
    end
    ...
    def BlockParametersNode(parameters, locals)
      BlockParametersNode.new(parameters, locals, Location.null)
    end
    ...
    # Create a new HeredocNode node
    def HeredocNode(opening, parts, closing, dedent)
      HeredocNode.new(opening, parts, closing, dedent, Location.null)
    end
    ...
    def ImaginaryNode()
      ImaginaryNode.new(Location.null)
    end
    ...
    def LambdaNode(scope, opening, lparen, parameters, rparen, statements)
      LambdaNode.new(scope, opening, lparen, parameters, rparen, statements, Location.null)
    end

    # Create a new LocalVariableReadNode node
    def LocalVariableReadNode()
      LocalVariableReadNode.new(Location.null)
    end

    # Create a new LocalVariableWriteNode node
    def LocalVariableWriteNode(name_loc, value, operator_loc)
      LocalVariableWriteNode.new(name_loc, value, operator_loc, Location.null)
    end
    ...
    def ParametersNode(requireds, optionals, rest, keywords, keyword_rest, block)
      ParametersNode.new(requireds, optionals, rest, keywords, keyword_rest, block, Location.null)
    end
    ...
    def RationalNode()
      RationalNode.new(Location.null)
    end
    ...
    def SourceFileNode()
      SourceFileNode.new(Location.null)
    end
