...
module Prism
  class RubyAPITest < TestCase
    ...
    def test_node_equality
      assert_equal parse_expression("1"), parse_expression("1")
      assert_operator parse_expression("1"), :eql?, parse_expression("1")
      assert_equal Prism.parse("1").value, Prism.parse("1").value

      complex_source = "class Something; @var = something.else { _1 }; end"
      assert_equal parse_expression(complex_source), parse_expression(complex_source)
