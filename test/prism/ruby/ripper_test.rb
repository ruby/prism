...
module Prism
  class RipperTest < TestCase
    ...
    UNSUPPORTED_EVENTS = %i[backtick comma comment heredoc_beg heredoc_end ident ignored_nl int kw label_end lbrace lbracket lparen nl op rbrace rbracket rparen semicolon sp symbeg tstring_beg tstring_end words_sep ignored_sp]
