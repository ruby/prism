...
typedef enum {
  YP_LEX_STATE_NONE = YP_LEX_STATE_BIT_NONE,
  YP_LEX_STATE_BEG = YP_LEX_STATE_BIT_BEG,
  YP_LEX_STATE_END = YP_LEX_STATE_BIT_END,
  YP_LEX_STATE_ENDARG = YP_LEX_STATE_BIT_ENDARG,
  YP_LEX_STATE_ENDFN = YP_LEX_STATE_BIT_ENDFN,
  YP_LEX_STATE_ARG = YP_LEX_STATE_BIT_ARG,
  YP_LEX_STATE_CMDARG = YP_LEX_STATE_BIT_CMDARG,
  YP_LEX_STATE_MID = YP_LEX_STATE_BIT_MID,
  YP_LEX_STATE_FNAME = YP_LEX_STATE_BIT_FNAME,
  YP_LEX_STATE_DOT = YP_LEX_STATE_BIT_DOT,
  YP_LEX_STATE_CLASS = YP_LEX_STATE_BIT_CLASS,
  YP_LEX_STATE_LABEL = YP_LEX_STATE_BIT_LABEL,
  YP_LEX_STATE_LABELED = YP_LEX_STATE_BIT_LABELED,
  YP_LEX_STATE_FITEM = YP_LEX_STATE_BIT_FITEM,
  YP_LEX_STATE_BEG_ANY = YP_LEX_STATE_BIT_BEG | YP_LEX_STATE_BIT_MID | YP_LEX_STATE_BIT_CLASS,
  YP_LEX_STATE_ARG_ANY = YP_LEX_STATE_BIT_ARG | YP_LEX_STATE_BIT_CMDARG,
  YP_LEX_STATE_END_ANY = YP_LEX_STATE_BIT_END | YP_LEX_STATE_BIT_ENDARG | YP_LEX_STATE_BIT_ENDFN,
} yp_lex_state_t;
