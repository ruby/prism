 ...
 */
bool
pm_newline_list_init(pm_line_offset_list_t *list, size_t capacity) {
 ...
 */
void
pm_newline_list_clear(pm_line_offset_list_t *list) {
    list->size = 1;
}
 ...
 */
bool
pm_newline_list_append(pm_line_offset_list_t *list, uint32_t cursor) {
 ...
 */
int32_t
pm_newline_list_line(const pm_line_offset_list_t *list, uint32_t cursor, int32_t start_line) {
    size_t left = 0;
 ...
 */
pm_line_column_t
pm_newline_list_line_column(const pm_line_offset_list_t *list, uint32_t cursor, int32_t start_line) {
    size_t left = 0;
    size_t right = list->size - 1;
 ...
 */
void
pm_newline_list_free(pm_line_offset_list_t *list) {
    xfree(list->offsets);
}
